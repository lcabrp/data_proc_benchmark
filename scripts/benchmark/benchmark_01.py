...
def setup_modin():
    ...
    import dask
    dask.config.set({
        "distributed.worker.memory.target": 0.95,  # 95% of total memory
        "distributed.worker.memory.spill": 0.96,   # Spill to disk if needed
...
def run_modin_operation(func, csv_path):
    ...
    cluster = LocalCluster(
        ...
        memory_limit="12GB",  # Lower memory limit

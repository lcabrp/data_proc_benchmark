...
python scripts/benchmark/benchmark.py -d data/raw/synthetic_logs_10M.csv -o data/benchmark_results.csv -opt always
...
# parquet
python scripts/benchmark/benchmark.py -d data/raw/synthetic_logs_10M.parquet -o data/benchmark_results.csv -opt always
